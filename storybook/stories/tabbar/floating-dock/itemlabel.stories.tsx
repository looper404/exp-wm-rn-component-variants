/**
 * Floating Dock Tabbar — itemlabel
 *
...
const meta = {
  title: 'Tabbar/Floating Dock Tabbar/itemlabel',
...
/** itemlabel left unset, so the component's own default applies. */
export const Default: Story = {
  args: {},
};

/** itemlabel set to a caller-supplied value. */
...
/** itemlabel empty — the fallback should hold. */
...
/** itemlabel long enough to test truncation. */
export const Long: Story = {
  args: {
    itemlabel: 'A deliberately long value, to show what happens when it does not fit',
  },
};
