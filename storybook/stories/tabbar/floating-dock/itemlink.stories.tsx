...
const meta = {
  title: 'Tabbar/Floating Dock Tabbar/itemlink',
...
/** itemlink left unset, so the component's own default applies. */
export const Default: Story = {
  args: {},
};

/** itemlink set to a caller-supplied value. */
...
/** itemlink empty — the fallback should hold. */
...
/** itemlink long enough to test truncation. */
export const Long: Story = {
  args: {
    itemlink: 'A deliberately long value, to show what happens when it does not fit',
  },
};
