...
export const DOCK_TABBAR_API: { props: DockTabbarApiProp[]; events: DockTabbarApiEvent[] } =
{
  "props": [
    ...
    },
    {
      ...
      "required": false,
      "default": null,
      "description": "Fill for the accent surface. Defaults to the accent constant in the styles file.",
      "source": "design"
    },
    {
      "name": "layout.barFill",
...
export const DOCK_TABBAR_PROP_NAMES = ["activeIndex","classname","dataset","disabled","getIcon","getLabel","iconPalette","itembadge","itemicon","itemlabel","itemlink","layout.accent","layout.barFill","maxvisibleitems","morebuttoniconclass","morebuttonlabel","name","numberOfItems","show","styles"] as const;
