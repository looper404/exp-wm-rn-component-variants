...
export const FLOATING_DOCK_TABBAR_API = {
    "props": [
        {
...
export const FLOATING_DOCK_TABBAR_PROP_NAMES = ["activeAccentColor", "activeBubbleColor", "activeIndex", "classname", "dataset", "disabled", "getIcon", "getLabel", "iconPalette", "itembadge", "itemicon", "itemlabel", "itemlink", "maxvisibleitems", "morebuttoniconclass", "morebuttonlabel", "name", "numberOfItems", "show", "showLabels", "styles"];
/** Event names, same reason. */
export const FLOATING_DOCK_TABBAR_EVENT_NAMES = ["onItemClick", "onItemSelect", "onLongPress", "onMoreClick", "onMoreItemClick"];
//# sourceMappingURL=floating-dock.api.js.map