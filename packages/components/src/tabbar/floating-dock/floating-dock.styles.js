 ...
 * `activeBubble` below).
 */
export const FLOATING_DOCK_TABBAR_ICON_PALETTE = {
...
export const FLOATING_DOCK_TABBAR_BUBBLE_HEIGHT = 30;
export const FLOATING_DOCK_TABBAR_BUBBLE_RADIUS = 10;
...
//# sourceMappingURL=floating-dock.styles.js.map