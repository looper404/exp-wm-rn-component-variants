...
export declare function createFloatingDockTabbarProps(partial?: FloatingDockTabbarProps): FloatingDockTabbarProps;
//# sourceMappingURL=floating-dock.props.d.ts.map