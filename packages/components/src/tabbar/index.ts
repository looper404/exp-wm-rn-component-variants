...
import { FloatingDockTabbar } from './floating-dock';

export {
  FloatingDockTabbar,
  createFloatingDockTabbarProps,
  type FloatingDockTabbarProps,
  type FloatingDockTabbarEvents,
  type FloatingDockTabbarStylesProp,
  FLOATING_DOCK_TABBAR_CLASS,
  FLOATING_DOCK_TABBAR_ICON_PALETTE,
} from './floating-dock';
...
export const TABBAR_VARIANT_COMPONENTS = {
  'floating-dock-tabbar': FloatingDockTabbar,
} as const;
